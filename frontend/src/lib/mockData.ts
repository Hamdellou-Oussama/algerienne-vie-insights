...
export type ProductKey = "prevoyance" | "ade-immo" | "ade-conso" | "ade-warda" | "ava" | "ia";
...
export const auditEvents = [
  {
    ...
    user: "Actuaire",
    role: "Actuaire",
    action: "Import SAP prévoyance 30/06/2025",
    target: "Prévoyance",
    status: "validé",
  },
  {
    ...
    user: "Actuaire",
    role: "Actuaire",
    action: "Extraction PPNA AVA/IA au 31/05/2025",
    target: "AVA / IA",
    status: "validé",
  },
  {
    ...
    user: "Actuaire",
    role: "Actuaire",
    action: "Chargement triangle IBNR ADE 2018-2025",
    target: "ADE",
    status: "validé",
  },
  {
    ...
    user: "Actuaire",
    role: "Actuaire",
    action: "Bilan technique PE 2022 chargé",
    target: "Toutes branches",
    status: "validé",
  },
  {
    id: 5,
    ...
    user: "Admin",
    role: "Admin",
    action: "Validation périmètre échantillon SAP",
    target: "Prévoyance",
    status: "validé",
  },
  {
    id: 6,
    date: "2025-05-31 16:00",
    user: "Admin",
    role: "Admin",
    action: "Contrôle cohérence PPNA vs SAP",
    target: "AVA / IA",
    status: "en cours",
  },
  {
    ...
    user: "Auditeur",
    role: "Auditeur",
    action: "Consultation triangle ADE",
    target: "ADE — IMMO",
    status: "consulté",
  },
  {
    ...
    user: "Actuaire",
    role: "Actuaire",
    action: "Vérification dates Échéance anormales",
    target: "ADE",
    status: "en cours",
  },
];
...
export const fmtNum = (v: number) => new Intl.NumberFormat("fr-FR").format(v);
