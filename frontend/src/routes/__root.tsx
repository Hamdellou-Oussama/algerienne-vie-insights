  ...
  head: () => ({
    meta: [
      ...
      { title: "L'Algérienne Vie — Plateforme de provisionnement technique" },
      {
        name: "description",
        content:
          "Plateforme de pilotage actuariel et opérationnel pour L'Algérienne Vie. PPNA, PSAP, IBNR, PRC et synthèse technique.",
      },
      { name: "author", content: "L'Algérienne Vie" },
      { property: "og:title", content: "L'Algérienne Vie — Plateforme technique" },
      {
        property: "og:description",
        content: "Pilotage actuariel et opérationnel des branches Vie & Prévoyance.",
      },
