...
export function SectionCard({
  ...
  return (
    <div
      className={`bg-card border border-border rounded-2xl shadow-md overflow-hidden transition-all duration-200 hover:shadow-lg hover:border-gold/30 group/section ${className}`}
    >
      {/* Header */}
